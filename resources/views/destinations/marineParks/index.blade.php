...
@section('content')
    ...
    <div class="banner pt-2 pl-4">
        <h1 class="display-4 ">Marine parks </h1>
    </div>
    <div class="p-4" style="background: #f7f9fa">
        <div class="container jumbotron-fluid">
            <p class="disp_title">Marine parks in Kenya have been established at the Coastal Kenya to protect the rich
                aquatic life abound in the Kenyan waters. If you love underwater photography and underwater flora and
                fauna excites you, come to the Kenya and enjoy your underwater paradise. From the Kisite Mpunguti Marine
                National Park in Kwale up to the Kiunga Marine National Reserve in Lamu, these protected waters thrive
                with pure marine life that brings color to this underworld. </p>
        </div>

    </div>

    <div class="park-wrapper">
        <h2 class="park-title">Malindi Marine park</h2>
        <div class="d-flex">
    ...
    <div class="park-wrapper">
        <h2 class="park-title">Watamu Marine Park</h2>
        <div class="d-flex">
    ...
    <div class="park-wrapper">
        <h2 class="park-title">Kisite Mpunguti Marine Park</h2>
        <div class="d-flex">
            <div class="content-img destination ">
                <img class="img-thumbnail" src="images/lakenakuruimg2.jpg" alt="Lake Nakuru image ">
    ...
    <div class="park-wrapper">
        <h2 class="park-title">Mombasa Marine Park</h2>
        <div class="d-flex">
            <div class="content-img destination ">
                <img class="img-thumbnail" src="images/lakenakuruimg2.jpg" alt="Lake Nakuru image ">
